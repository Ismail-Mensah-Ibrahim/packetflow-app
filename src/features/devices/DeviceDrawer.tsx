	...
	const renderDeviceItem = (device: (typeof DEVICE_CATALOG)[0]) => {
		...
		return (
			...
			>
				...
				>
					<Text
						style={{ color, fontSize: 18, lineHeight: 22, fontWeight: "800" }}
					>
						+
					</Text>
				</View>
			...
			{activeTab === "devices" ? (
					...
					>
						...
						<View style={{ flex: 1 }}>
							...
							<Text style={{ color: "#64748B", fontSize: 12, marginTop: 1 }}>
								Tap two devices to connect them
							</Text>
						</View>
					</Pressable>
				...
				>
					...
					>
						...
						<View style={{ flex: 1 }}>
							<Text
								style={{ color: "#F1F5F9", fontSize: 14, fontWeight: "700" }}
							>
					...
					<View
						style={{
							...
							alignItems: "center",
							gap: 6,
							marginTop: customTemplates.length > 0 ? 4 : 0,
						}}
					>
					...
					>
						...
						<View style={{ flexDirection: "row", gap: 10, marginTop: 4 }}>
							...
							<Pressable
								...
								style={{
									flex: 1,
									backgroundColor: saveName.trim() ? "#8B5CF6" : "#4C3880",
									borderRadius: 12,
									paddingVertical: 12,
									alignItems: "center",
								}}
