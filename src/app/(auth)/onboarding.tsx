...
function TopologyIllustration() {
	return (
		<Svg width={220} height={200} viewBox="0 0 220 200">
			...
			<Path
				d="M170 132 L194 140 L194 158 Q194 168 170 172 Q146 168 146 158 L146 140 Z"
				fill="#111827"
				stroke="#EF4444"
				strokeWidth={1.8}
			/>
			<Path
				d="M170 142 Q174 146 172 152 Q170 148 168 150 Q171 153 170 160 Q166 156 168 152 Q164 150 166 147 Q168 150 170 150 Q169 146 170 142Z"
				fill="#EF4444"
				opacity={0.8}
			/>
			{/* Labels */}
			...
			<SvgText x={55} y={57} textAnchor="middle" fill="#8B5CF6" fontSize={8}>
				SW-1
			</SvgText>
			<SvgText x={165} y={57} textAnchor="middle" fill="#8B5CF6" fontSize={8}>
				SW-2
			</SvgText>
			<SvgText x={50} y={178} textAnchor="middle" fill="#10B981" fontSize={8}>
				PC-1
			</SvgText>
			<SvgText x={170} y={183} textAnchor="middle" fill="#EF4444" fontSize={8}>
				FW-1
			</SvgText>
		</Svg>
	);
...
function DragDropIllustration() {
	return (
		<Svg width={220} height={200} viewBox="0 0 220 200">
			...
			{/* Drag arrow */}
			<Path
				d="M68 95 L78 80 L80 88 L85 75 L90 86 L88 93 L78 88 Z"
				fill="#22D3EE"
				opacity={0.7}
			/>
		</Svg>
...
const SLIDES: Slide[] = [
	{
		...
		subtitle:
			"Build professional network diagrams with routers, switches, firewalls and more.",
	...
	},
	{
		...
		subtitle:
			"Drag devices onto your canvas, connect them with cables and configure every detail.",
	...
	},
	{
		...
		subtitle:
			"Run CLI commands, ping devices and watch your topology come to life.",
