...
function _GitHubIcon({ isDark }: { isDark?: boolean }) {
	return (
		<Svg
			width={18}
			height={18}
			viewBox="0 0 24 24"
			fill={isDark ? "white" : "#24292e"}
		>
			...
			>
				...
				<View className="gap-4">
					...
					<View className="flex-row items-center justify-between">
						...
						>
							<View
								className={`w-4 h-4 rounded border ${rememberMe ? "bg-primary border-primary" : "border-border bg-card"}`}
							>
								{rememberMe && (
