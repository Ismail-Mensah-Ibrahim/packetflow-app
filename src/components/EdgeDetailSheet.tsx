...
export function EdgeDetailSheet({ edgeId, onClose }: EdgeDetailSheetProps) {
	...
	const cableColor =
		(CABLE_COLORS as Record<string, string>)[edge.cable_type] ?? "#3B82F6";
	const cableLabel =
		(CABLE_LABELS as Record<string, string>)[edge.cable_type] ??
		edge.cable_type;
				...
				<View style={{ flexDirection: "row", flexWrap: "wrap", gap: 6 }}>
					<Pressable
						...
						style={{
							...
							borderWidth: 1,
							borderColor: vlanInput === "" ? "#64748B" : "#1E293B",
						}}
					>
						<Text
							style={{
								color: vlanInput === "" ? "#F1F5F9" : "#64748B",
								fontSize: 12,
								fontWeight: "600",
							}}
						>
					...
					{PRESET_VLANS.map((v) => (
						<Pressable
							...
							style={{
								...
								borderRadius: 8,
								backgroundColor:
									vlanInput === String(v) ? "#312E81" : "#1E293B",
								borderWidth: 1,
								borderColor: vlanInput === String(v) ? "#6366F1" : "#1E293B",
							}}
						>
							<Text
								style={{
									color: vlanInput === String(v) ? "#A5B4FC" : "#64748B",
									fontSize: 12,
									fontWeight: "700",
								}}
							>
			...
			<View style={{ flexDirection: "row", gap: 10 }}>
				<Pressable
					...
					style={{
						...
						height: 44,
						borderRadius: 12,
						backgroundColor: "#F87171" + "18",
						borderWidth: 1,
						borderColor: "#F87171" + "33",
						alignItems: "center",
						justifyContent: "center",
					}}
				>
