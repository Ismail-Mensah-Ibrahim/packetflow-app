...
| Item | Details |
|------|---------|
| Submit endpoint | `POST https://app-cyi7jn4dtfcx-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video` |
| Query endpoint | `GET https://app-cyi7jn4dtfcx-api-oYA6Z8wDBRDa.gateway.appmedo.com/v1/videos/image2video/{id}` |
