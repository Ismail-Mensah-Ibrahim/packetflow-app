...
**Endpoint:** `GET https://app-cyi7jn4dtfcx-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-cyi7jn4dtfcx-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
