...
| Property | Value |
|----------|-------|
| Submit Endpoint | `POST https://app-cyi7jn4dtfcx-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video` |
| Query Endpoint | `GET https://app-cyi7jn4dtfcx-api-pLVzAEz1ZQOL.gateway.appmedo.com/v1/videos/omni-video/{task_id}` |
