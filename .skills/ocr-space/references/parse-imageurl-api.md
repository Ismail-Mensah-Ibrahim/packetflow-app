...
| Property | Value |
|----------|-------|
| Endpoint | `GET https://app-cyi7jn4dtfcx-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl` |
...
async function ocrParseImageUrl(
  ...
  const response = await fetch(
    `https://app-cyi7jn4dtfcx-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl?${params.toString()}`,
    {
      method: "GET",
      headers: {
